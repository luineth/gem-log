...
export global_url="gemini://pishon.garden/log/" # link to base url of gemlog
export global_author="Alexa Kay"
export global_author_email=""
export global_author_url="gemini://pishon.garden/" # homepage of author
export global_license="CC BY SA 4.0"
...
export feed_base_url="gemini://pishon.garden/log/" # base url that the feed is hosted at
export feed_web_url="https://pishon.garden/log/" # base url that the feed is hosted at on the web
